...
// import { addOperation, addChildrenToOperation, OPERATION_TYPE_STACK, createOperation, addTableToDeepestOperation } from "../../../../data/slices/operationsSlice/index.js";
...
// import { DROP_TARGET_EVENT_INITIALIZE, DROP_TARGET_EVENT_PACK, DROP_TARGET_EVENT_STACK } from "../../../CompositeTableSchema/TableDropTarget.jsx";
...
//                             dispatch(addTableToDeepestOperation({
//                                 tableId: table.id
//                             }));
//                             break;
...
//                             break;
//                         default:
//                             throw new Error(`Unknown operation type: ${result.operationType}`);
//                     }
//                 }
//                 setIsPressed(false);
//             },
