...
import withMatchDetailData from "./withMatchDetailData";
...
function MatchDetail({
  ...
  const sortedMatchGroups = rawMatchGroups;
...
const EnhancedMatchDetail = withMatchDetailData(MatchDetail);

EnhancedMatchDetail.displayName = "MatchDetail";

export default EnhancedMatchDetail;
