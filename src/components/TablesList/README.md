...
* `TablesList.jsx`: The primary component for displaying all source tables in the workspace.
* `TablesToolbar.jsx`: Header component with search and upload controls.
