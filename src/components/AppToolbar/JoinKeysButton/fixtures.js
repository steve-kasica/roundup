  ...
  operations: {
    ...
    byId: {
      o1: {
        id: "o1",
        name: null,
        databaseName: "o__cr3ej3_mkpq9p1j",
        operationType: "pack",
        parentId: null,
        childIds: ["t1", "t2"],
        columnIds: [],
  ...
  tables: {
    ...
    byId: {
      t1: {
        ...
        parentId: "o1",
        source: "file upload",
        databaseName: "t_ii1pfp_mkpq9mw2",
        name: "lambert_2",
      ...
      t2: {
        ...
        parentId: "o1",
        source: "file upload",
        databaseName: "t_km5wpt_mkpq9mzj",
        name: "violent_crimes",
...
export const nestedOperationState = {
  ui: {
    hoveredColumnIds: [],
    selectedColumnIds: ["c3", "c6", "c48", "c51"],
    focusedColumnIds: [],
    visibleColumnIds: [],
    hiddenColumnIds: [],
    draggingColumnIds: [],
  ...
  operations: {
    ...
    byId: {
      o1: {
        id: "o1",
        name: null,
        databaseName: "o__iuclhf_mkqumz21",
        operationType: "stack",
        parentId: "o2",
        childIds: ["t1", "t2"],
        columnIds: ["c71", "c72"],
      ...
      o2: {
        id: "o2",
        name: null,
        databaseName: "o__zbs97p_mkquqg3m",
        operationType: "pack",
        parentId: null,
        childIds: ["o1", "t3"],
        columnIds: [],
  ...
  tables: {
    ...
    byId: {
      t1: {
        ...
        parentId: "o1",
        source: "file upload",
        databaseName: "t_ohro4v_mkqumwgb",
        name: "lambert_1",
      ...
      t2: {
        ...
        parentId: "o1",
        source: "file upload",
        databaseName: "t_fgt627_mkqumwjp",
        name: "lambert_2",
        fileName: "lambert_2.csv",
        extension: "csv",
        size: 16225,
      ...
      t3: {
        ...
        parentId: "o2",
        source: "file upload",
        databaseName: "t_g3nd10_mkqumwjy",
        name: "violent_crimes",
        fileName: "violent_crimes.csv",
        extension: "csv",
        size: 4508437,
  ...
  alerts: {
    allIds: ["o2_JOIN_KEY_LEFT_MISSING", "o2_JOIN_KEY_RIGHT_MISSING"],
    byId: {
      o2_JOIN_KEY_LEFT_MISSING: {
        timeStamp: 1769170999813,
        ...
        id: "o2_JOIN_KEY_LEFT_MISSING",
      },
      o2_JOIN_KEY_RIGHT_MISSING: {
        timeStamp: 1769170999813,
