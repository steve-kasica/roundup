export const state = {
  ui: {
    ...
    focusedColumnIds: [],
    visibleColumnIds: ["c41", "c42", "c43", "c44", "c45"],
    hiddenColumnIds: [],
    draggingColumnIds: [],
    dropTargetColumnIds: [],
    focusedObjectId: "o1",
  ...
  operations: {
    ...
    byId: {
      o1: {
        id: "o1",
        name: null,
        databaseName: "o__vjb0s2_mkli8903",
        operationType: "stack",
        parentId: null,
        childIds: ["t1", "t2"],
        columnIds: [],
  ...
  tables: {
    ...
    byId: {
      t1: {
        ...
        parentId: "o1",
        source: "file upload",
        databaseName: "t_wsd259_mkli86vu",
        name: "lambert_1",
      ...
      t2: {
        ...
        parentId: "o1",
        source: "file upload",
        databaseName: "t_s85kwx_mkli86z4",
        name: "lambert_2",
      ...
      t3: {
        ...
        parentId: null,
        source: "file upload",
        databaseName: "t_g65im5_mkli86zb",
        name: "violent_crimes",
  ...
  alerts: {
    allIds: ["o1_INCONGRUENT_TABLES"],
    byId: {
      o1_INCONGRUENT_TABLES: {
        timeStamp: 1768847664535,
        code: "INCONGRUENT_TABLES",
        name: "Incongruent Tables",
        description:
        ...
        isSilenced: false,
        message:
          "Stack operation  has incongruent child tables with differing column counts.",
        id: "o1_INCONGRUENT_TABLES",
      },
    },
  },
};
